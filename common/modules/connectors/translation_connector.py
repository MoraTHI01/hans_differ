...
class TranslationConnector(Connector):
    ...
    def __init__(
        ...
        :param str translation_model_id: translation model id
        :param str translation_config: translation model configuration
        ...
        if self.use_orchestrator:
            ...
            self.pre_url_raw = "http://" + self.server + ":" + self.port + "/" + self.orchestrator_translation_route
    ...
    def _gen_payload(self, prompt):
        ...
        """
        return {"inputs": prompt, "parameters": {"max_new_tokens": self.translation_config["max_new_tokens"]}}
    ...
    def translate_iter(self, url, content, source_language, target_language):
        ...
        """
        partial_message = ""
        text_arr = self.split_text_into_chunks(content.strip(), int(self.translation_config["max_new_tokens"] / 128))
    ...
    def get_info(self):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                json_data["max_new_tokens"] = self.translation_config["max_new_tokens"]
                return json_data
            else:
                return None
        except (
