...
#SBATCH --partition=p3             # Used partition only p3 possible for L40S
...
#SBATCH --qos=advanced             # Quality-of-Service, For more than one gpu you need to request for gpuultimate
...
#SBATCH --container-image=/nfs/scratch/staff/<YOUR_USER_ID>/tei/text-embeddings-inference-89-1.5.sqsh # Loading the previously saved image
