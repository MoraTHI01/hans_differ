#!/bin/bash
#SBATCH --job-name=tgi-m8x7b-I01   # Short name for the job
...
#SBATCH --container-image=/nfs/scratch/staff/<YOUR_USER_ID>/tgi/text-generation-inference-v2.3.1.sqsh # Loading the previously saved image
